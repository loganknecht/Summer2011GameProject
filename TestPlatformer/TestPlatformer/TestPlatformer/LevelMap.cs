...
namespace TestPlatformer
{
    class LevelMap
    {
        ...
        public LevelMap(ContentManager cm, GraphicsDeviceManager gdm, SpriteBatch sb, Vector2 tileMapWidthAndHeight, Vector2 defaultTileWidthAndHeight)
        {
        ...
        public Vector2 checkForAndFixCollidableTileCollisionWithPlayer(Vector2 expectedPosition, Player playerOne, Camera playerCamera)
        {
            ...
            while (heightTracker < endQuadrantY)
            {
                while (widthTracker < endQuadrantX)
                {
                    ...
                    //System.Diagnostics.Debug.WriteLine("End Quadrant X: " + endQuadrantX);
                    //System.Diagnostics.Debug.WriteLine("End Quadrant Y: " + endQuadrantY);
                    if (widthTracker < endQuadrantX && heightTracker < endQuadrantY) {
