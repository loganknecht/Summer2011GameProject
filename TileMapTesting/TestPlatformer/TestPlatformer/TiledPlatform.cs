...
namespace TestPlatformer
{
    class TiledPlatform {
        ...
        //best name I could think for this, this represents the number that will modify the player's velocity in both directions
        ...
        public void Draw() {
            imageSheet.Draw(false, true, platformSize);
        }
        ...
        public Vector2 checkAndFixTiledPlatformCollision(Vector2 newPos, Player player)
        {
            //------------
